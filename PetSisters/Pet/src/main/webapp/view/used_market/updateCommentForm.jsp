...
<html class='no-js' >
	<head>
		...
		<title>UsedMarket Comment 수정</title>
		...
		<script type="text/javascript">
 		  function updateUsedMarketComment() {	
 		  ...
 		  function backUsedMarketDetail(targetUri) {
				...
				<div class='portfolio-block section-block' >
					...
					<div class='container' >
						...
						<form name="form" action="<c:url value='/comment/updateComment.do/${comment.cNum}'/>">
 			 				...
 			 				<div class='section-header text-center'>
								<input type="submit" value="Comment 수정" onclick="updateUsedMarketComment()" class="btn btn-default btn-lg">
								
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
								<button type="button" onclick="backUsedMarketDetail('<c:url value="/used_market/unum/${comment.crNum}"/>')" class="btn btn-default btn-lg">취소</button>
							</div>					 
